        ...
        <article className="prose prose-invert max-w-none space-y-12">
          ...
          <section>
            ...
            <ul className="space-y-4 text-neutral-300 list-disc ml-6 text-[17px]">
              ...
              <p><strong>Point to Note: <br/>So, you might get the doubt that "Why even use int/short when we can just always use long long because it covers more numbers that we can use?"</strong>. <br/>Before understanding why, let's understand how much memory space is being used when these data types are used:
